...
export const storiesApi = {
  getPaginatedStories: (params = {}) => {
        ...
        // Always include the tag parameter
        if (params.tag) {
        ...
        // Add cache-busting parameter if present
        if (params._t) {
        ...
        // Include cache-busting param in cache key to prevent cached responses
        const cacheKey = `paginated-stories-${tag}-${params.page || '1'}${params._t ? `-${params._t}` : ''}`;
