...
export const siteUrl = (path = '/') => {
  ...
  if (!siteBase) {
    siteBase = process.env.NEXT_PUBLIC_SITE_URL || 'https://storyvermo.com';
  }
...
// ============================================================================
// PAYMENTS ENDPOINTS (Paystack Integration)
// ============================================================================
export const PAYMENTS_API = {
  ...
  VERIFY: (reference) => buildUrl(`${API_BASE_URL}/api/payments/verify/`, { reference }),
  
  // Webhook endpoint (backend to backend - for reference)
