        ...
        return (
            <div className="image-container" style={{ display: storyDeleted ? 'none' : 'block' }}>
                ...
                >
                    ...
                    <div 
                        ref={hologramRef}
                        className="fixed-hologram absolute bottom-20 left-[5%] right-[5%] bg-black/60 backdrop-blur-[0.5px] border-2 border-[rgba(80,105,219,0.4)] rounded-2xl p-3 overflow-visible max-md:bottom-[100px] "
                        style={{
                            position: 'absolute',
